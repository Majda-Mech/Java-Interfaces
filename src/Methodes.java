...
public abstract class Methodes {
   ...
   abstract void surf(Pokemon name, Pokemon enemy);

   abstract void fireLash(Pokemon name, Pokemon enemy);

   abstract void leafStorm(Pokemon name, Pokemon enemy);

   abstract void hydroPump(Pokemon name, Pokemon enemy);

   abstract void thunderPunch(Pokemon name, Pokemon enemy);

   abstract void electroBall(Pokemon name, Pokemon enemy);

   abstract public void solarBeam(Pokemon name, Pokemon enemy);

   abstract void flameThrower(Pokemon name, Pokemon enemy);

   abstract void hydroCanon(Pokemon name, Pokemon enemy);

   abstract void pyroBall(Pokemon name, Pokemon enemy);

   abstract void thunder(Pokemon name, Pokemon enemy);

   abstract void rainDance(Pokemon name, Pokemon enemy);

   abstract public void leechSeed(Pokemon name, Pokemon enemy);

   abstract public void leaveBlade(Pokemon name, Pokemon enemy);

   abstract void inferno(Pokemon name, Pokemon enemy);

   abstract void voltTackle(Pokemon name, Pokemon enemy);
